...
author: "Gabriele Gatulyte, 1811329" 
...
# df <- namq_10_gdp %in% filter(geo=="EE" | geo =="LV" |geo=="LT",na_item=="D1",s_adj =="SCA",time>="2000-01-01",unit=="PC_GDP")
```
...
# scale_x_date(date_labels="%Y", date_breaks="1year")+
# theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
# labs(title="Compensation of employees", index 2010="100", subtitle="Source: Eurostat(namq_10_gdp)", x="Time", y="Index")
```
...
# geom_bar(stat="identity", fill="stellblue")+
# scale_x_date(date_labels="%Y", date_breaks="1year")+
# geom_text(aes(label=values), vjust = -0.5, size = 3.5)+
# labs(title="Darbo pajamų ir BVP santykis", subtitle="Source:Eurostat()", x="countries", y="As % GDP")
```
